...
toilet -f future "Rycoder lolcat

echo "-------------------------------------------------------" | lolcat

echo   "Author   : Rycoder $Ry" |lolcat

echo   "Contact  : https://t.me/Termux_boy $Ry" |lolcat

echo   "YouTube  : Rycoder_2 🖤 |lolcat

echo   "instagram     : https://instagram.com/rycoder_1?igshid=NDk5N2NlZjQ= $white" |lolcat
