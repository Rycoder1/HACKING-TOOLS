...
xdg-open https://youtube.com/@Rycoder_1
...
toilet -f future "RY CODER" | lolcat

echo "-------------------------------------------------------" | lolcat

echo   "Created  : Rycoder $white" |lolcat

echo   "Contact  : Instagram.com/rycoder_1 $white" |lolcat

echo   "YouTube  : Rycoder_1 $white" |lolcat
